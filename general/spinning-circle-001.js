...
function draw() {
  ...
  // Calculate the position of the spinning shape based on the current angle
  let x = centerX + cos(angle) * 100;
  let y = centerY + sin(angle) * 100;
  ...
  // Update the angle of the spinning shape
  angle += 0.05;
